...
public class AttoriResponseResultsKnownFor {
    ...
    public AttoriResponseResultsKnownFor() {
    }

    public AttoriResponseResultsKnownFor(boolean for_adult, String backdrop_path, List<Integer> genre_id, int id, String original_language, String original_title, String overview, String poster_path, String release_date, String title, boolean video, float vote_average) {

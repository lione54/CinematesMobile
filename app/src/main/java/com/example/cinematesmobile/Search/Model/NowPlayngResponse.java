...
public class NowPlayngResponse {
    ...
    public NowPlayngResponse() {
    }

    public NowPlayngResponse(Integer page, List<MovieResponseResults> results, Integer total_pages, Integer total_results) {
        this.page = page;
